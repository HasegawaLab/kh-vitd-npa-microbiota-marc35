...
class(table1_tb$PAM4_m35)
table1_tb$PAM4_m35 <- relevel (table1_tb$PAM4_m35, "Moraxella dominant") 

# Covariates to consider
# + Agecat3 + female + raceethn
# + premature37 
# + mata_delivery
# + prev_breathingprob2 +intake_daycare +children_home2 
# + breastmilk_mostly_3mo
# + antibiotics_life + corticosteroids_life + intch_antibiotics_ed  
# + RSV_NPA + RV_NPA
# + LL37_ngml2


# No interaction model
  model_no_int <- glmer (IntensiveTreatment ~ PAM4_m35
...
# Interaction model
  model_int <- glmer (IntensiveTreatment ~ PAM4_m35
...
pchisq(as.numeric(G2), df=3, lower.tail=F)  # If we use 25OHD as a binomal variable, df = 7 (limited power).

```
Stratification -- low total 25OHD
```{r}
