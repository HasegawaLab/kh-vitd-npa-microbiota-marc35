...
genus_mat <- genus_mat[ ,genus_zero_abundance==FALSE]
...
```{r Table 1, eval=TRUE}
    ...
    table1_tb <- metadata_pam %>% select (-c(intake_sex, HRV, genotype_RV))  # For Table 1, remove some variables
...
# Scree plot
    tune.pca(X, 
             ...
             scale  = FALSE)     # TRUE  = scaling to give similar weights to all genera in the analysis 
